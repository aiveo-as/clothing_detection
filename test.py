...
from models.yolos.experimental import attempt_load
from models.yolos.general_utils import (
...
from models.yolos.torch_utils import select_device, time_synchronized
...
def test(val_loader,
    ...
    # Configure
    model.eval()
    with open("models/yolos/configs/yolov4-p5.yaml") as f:
    ...
    for batch in val_loader:
        imgs = (batch["imgs"].to(device) / 255).permute(0, 3, 1, 2)
        bboxs = batch["bboxs"]
        ids = batch["ids"]
        ...
        with torch.no_grad():
            ...
            #     loss += compute_loss([x.float() for x in train_out], bboxs, model)[1][:3]  # GIoU, obj, cls
